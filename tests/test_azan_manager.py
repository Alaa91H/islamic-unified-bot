...
from azan_manager import (
    AzanScheduler, AzanStreamer, AzanNotificationManager,
    NotificationType, UserAzanSettings,
)
...
class TestUserAzanSettings:
    ...
    def test_to_dict_has_required_keys(self):
        ...
        d = s.to_dict()
        for key in ("user_id", "city", "method", "timezone",
                    "notification_enabled", "stream_enabled"):
...
class TestAzanScheduler:
    ...
    def test_update_user_settings(self):
        ...
        result = self.scheduler.update_user_settings(
            300, notification_enabled=False
        )
        assert result is True
