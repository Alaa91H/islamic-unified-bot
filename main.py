...
from azan_commands import register_azan_commands
...
def get_config():
    return {
        ...
        "MUSIC_DIR": os.getenv("MUSIC_DIR", "/home/ubuntu/islamic_bot/music"),
        "QURAN_STREAM_URL": os.getenv(
    ...
    ADHKAR = {
        "morning": [
            {
                ...
                "benefit": "يُكتب لقائله كل يوم مائة حسنة",
            },
            {
                ...
                "benefit": "حصن عظيم من الشياطين والأمراض الروحية",
            },
            {
                "title": "🌟 آية الكرسي",
                "text": "اللَّهُ لَا إِلَٰهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ ۚ لَا تَأْخُذُهُ سِنَةٌ وَلَا نَوْمٌ...",
                "benefit": "أفضل آية في القرآن الكريم، حماية عظيمة طوال اليوم",
            },
            {
                "title": "💫 اللهم إني أسألك",
                "text": "اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلًا تَقَبَّلُهُ",
                "benefit": "دعاء يومي شامل يجمع أعظم الحاجات",
            },
            {
                ...
                "benefit": "استسلام كامل لله في كل أحوالنا",
            },
        ],
        "evening": [
            {
        ...
        "sleep": [
            ...
            },
            {
                ...
                "benefit": "عصمة من كل سوء",
            },
        ],
        "entry": [
            {
                "title": "🚪 الدخول إلى البيت",
                "text": (
                    "بِسْمِ اللَّهِ، دَخَلْنَا بِسْمِ اللَّهِ،"
                    " وَخَرَجْنَا بِسْمِ اللَّهِ، وَعَلَى اللَّهِ رَبِّنَا تَوَكَّلْنَا"
                ),
                "benefit": "حماية وبركة في البيت",
            },
            {
                "title": "✨ الخروج من البيت",
                "text": "بِسْمِ اللَّهِ، تَوَكَّلْتُ عَلَى اللَّهِ، لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ",
                "benefit": "حماية في الطريق والمسير",
            },
            {
                "title": "🚗 دخول المسجد",
                "text": "بِسْمِ اللَّهِ، السَّلَامُ عَلَى رَسُولِ اللَّهِ، اللَّهُمَّ افْتَحْ لِي أَبْوَابَ رَحْمَتِكَ",
                "benefit": "استقبال مبارك للمسجد",
            },
        ],
        "prayer": [
            {
                "title": "🤲 قبل الصلاة",
                "text": "اللَّهُمَّ اجْعَلْ نِيَّتِي خَالِصَةً لِوَجْهِكَ الْكَرِيمِ",
                "benefit": "إخلاص النية في العبادة",
            },
            {
                "title": "💫 الصلاة الإبراهيمية",
                "text": "اللَّهُمَّ صَلِّ عَلَىٰ مُحَمَّدٍ وَعَلَىٰ آلِ مُحَمَّدٍ...",
                "benefit": "محبة النبي وتعظيمه",
            },
            {
                "title": "✨ بعد التسليم",
                "text": "أَسْتَغْفِرُ اللَّهَ (3 مرات)\nاللَّهُمَّ أَنْتَ السَّلَامُ، وَمِنْكَ السَّلَامُ",
                "benefit": "ختم الصلاة بالاستغفار",
            },
        ],
        "journey": [
            {
                ...
                "benefit": "حماية وتسخير الركوب",
            },
            {
                "title": "🏨 العودة من السفر",
                "text": "آيِبُونَ، تَائِبُونَ، عَابِدُونَ، لِرَبِّنَا حَامِدُونَ",
                "benefit": "تكبير العودة من السفر",
            },
        ],
        "supplication": [
            {
                "title": "🙏 دعاء الاستجابة",
                "text": "يَا عَلِيمُ يَا قَدِيرُ، يَا رَحِيمُ يَا كَرِيمُ، اللَّهُمَّ اسْتَجِبْ دُعَاءَنَا",
                "benefit": "دعاء مستجاب بإذن الله",
            },
            {
                "title": "🎯 دعاء تفريج الكرب",
                "text": "لَا إِلَٰهَ إِلَّا أَنْتَ سُبْحَانَكَ إِنِّي كُنتُ مِنَ الظَّالِمِينَ",
                "benefit": "فرج من كل ضيق وكرب",
            },
        ],
        "tasbeeh": [
            {
                "title": "📿 التسبيح (سبحان الله)",
                "text": "سُبْحَانَ اللَّهِ (100 مرة)",
                "benefit": "تنزيه الله عن كل نقص",
            },
            {
                "title": "🎉 التحميد (الحمد لله)",
                "text": "الْحَمْدُ لِلَّهِ (100 مرة)",
                "benefit": "شكر نعم الله",
            },
            {
                "title": "💫 التسبيح الرباعي",
                "text": "سُبْحَانَ اللَّهِ، وَالْحَمْدُ لِلَّهِ، وَلَا إِلَٰهَ إِلَّا اللَّهُ، وَاللَّهُ أَكْبَرُ",
                "benefit": "أشمل وأعظم الأذكار",
            },
        ],
        "protection": [
            {
                "title": "🛡️ الرقية الشرعية",
                "text": "بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ\nقُلْ هُوَ اللَّهُ أَحَدٌ... (3 مرات)",
                "benefit": "أقوى حماية من الأمراض والعين",
            },
            {
                "title": "💫 حصن من كل شر",
                "text": "بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلَا فِي السَّمَاءِ",
                "benefit": "حصن منيع من كل ضرر",
            },
        ],
        "gratitude": [
            {
                "title": "🎁 شكر الله",
                "text": "الْحَمْدُ لِلَّهِ عَلَىٰ كُلِّ نِعْمَةٍ، وَالشُّكْرُ لِلَّهِ عَلَىٰ كُلِّ فَضْلٍ",
                "benefit": "زيادة النعم",
            },
            {
                "title": "💫 الرضا بقضاء الله",
                "text": "رَضِيتُ بِاللَّهِ رَبًّا، وَبِالْإِسْلَامِ دِينًا، وَبِمُحَمَّدٍ نَبِيًّا (3 مرات)",
                "benefit": "رضا القلب والطمأنينة",
            },
        ],
        "family": [
            {
                "title": "👨‍👩‍👧 دعاء الوالدين",
                "text": "رَبِّ اغْفِرْ لِي وَلِوَالِدَيَّ وَرَحْمَهُمَا كَمَا رَبَّيَانِي صَغِيرًا",
                "benefit": "دعاء للوالدين والبر بهما",
            },
            {
                "title": "👪 سعادة العائلة",
                "text": "اللَّهُمَّ اجْعَلْ بَيْتَنَا أَمِنًا مُطْمَئِنًّا، وَاجْعَلْ أَهْلَنَا مِنَ الصَّالِحِينَ",
                "benefit": "أمن وسلام بيتي",
            },
        ],
        "health": [
            {
                "title": "⚕️ دعاء الشفاء",
                "text": "اللَّهُمَّ يَا مَنْ تُمْسِكُ السَّمَاءَ أَنْ تَقَعَ، أَدْعُوكَ أَنْ تَشْفِي مَرِيضَنَا",
                "benefit": "شفاء من الأمراض",
            },
            {
                "title": "💪 العافية والصحة",
                "text": (
                    "اللَّهُمَّ عَافِنِي فِي بَدَنِي،"
                    " اللَّهُمَّ عَافِنِي فِي سَمْعِي،"
                    " اللَّهُمَّ عَافِنِي فِي بَصَرِي"
                ),
                "benefit": "صحة وعافية كاملة",
            },
        ],
    }
...
class StreamManager:
    ...
    async def start(self):
        try:
            ...
            # تسجيل معالج للأخطاء لإعادة تشغيل البث تلقائياً
            @self.pytgcalls.on_stream_end()
            async def on_stream_end(client, update):
                chat_id = update.chat_id
                if chat_id in self.streams:
                    info = self.streams[chat_id]
                    logger.info(f"🔄 انقطع البث في {chat_id}، جاري إعادة التشغيل...")
                    await self.start_stream(chat_id, info["url"], info["title"])
    ...
    async def start_stream(
        ...
        chat_id: int,
        media_url: str,
        title: str = "البث المباشر",
        attempts: int = 0,
    ) -> bool:
        try:
            # إعداد البث باستخدام MediaStream مع جودة صوتية عالية
            media = MediaStream(
                media_url,
                audio_parameters=AudioQuality.HIGH,  # جودة عالية 48kHz
                ffmpeg_parameters="-af volume=1.5",  # تحسين الصوت
            )
            ...
            logger.info(f"✅ بدء البث عالي الجودة في {chat_id}: {title}")
            return True
        except NotInCallError:
            logger.warning(f"⚠️ البوت موجود بالفعل في {chat_id}")
            return True  # نعتبره نجاحاً لأنه يبث بالفعل
        except Exception as e:
            max_attempts = CONFIG.get("MAX_RECONNECT_ATTEMPTS", 5)
            if attempts < max_attempts:
                delay = CONFIG.get("INITIAL_RECONNECT_DELAY", 5) * (attempts + 1)
                logger.error(
                    f"❌ خطأ في بدء البث ({attempts + 1}/{max_attempts}): {e}. إعادة المحاولة خلال {delay} ثانية..."
                )
                await asyncio.sleep(delay)
                return await self.start_stream(chat_id, media_url, title, attempts + 1)

            logger.error(f"❌ فشل بدء البث نهائياً بعد {max_attempts} محاولات: {e}")
            return False
...
async def adhkar_command(client: Client, message: Message):
    keyboard_list = [
        ...
        for k, v in IslamicData.CATEGORIES.items()
    ]
    await message.reply_text(
    ...
    try:
        ...
        if stream_type == "quran":
            ...
            success = await stream_manager.start_stream(
                chat_id, url, f"{surah_num} - {name}"
            )
            if success:
                await message.reply_text(
                    f"✅ بدأ البث: **{surah_num} - {name}**\n📍 `{chat_id}`",
                    parse_mode="Markdown",
                )
            else:
            ...
            info = files[file_num]
            success = await stream_manager.start_stream(
                chat_id, info["path"], info["name"]
            )
            if success:
                await message.reply_text(
                    f"✅ بدأ البث: **{info['name']}**", parse_mode="Markdown"
                )
            else:
                await message.reply_text("❌ فشل بدء البث")
            ...
            if success:
                await message.reply_text(
                    f"✅ بدأ البث من الرابط في `{chat_id}`", parse_mode="Markdown"
                )
            else:
                await message.reply_text("❌ فشل بدء البث")
        else:
...
async def stop_command(client: Client, message: Message):
    ...
    if success:
        await message.reply_text(
            f"✅ تم إيقاف البث في `{chat_id}`", parse_mode="Markdown"
        )
    else:
        ...
        # ---- الأذكار ----
            ...
            for i, adhkar in enumerate(adhkar_list):
                keyboard_list.append(
                    [
                        InlineKeyboardButton(
                            f"{i+1}. {adhkar['title'][:35]}",
                            callback_data=f"adhkar_{category}_{i}",
                        )
                    ]
                )
            keyboard_list.append(
                [InlineKeyboardButton("🔙 الرجوع", callback_data="main_adhkar_menu")]
            )
            await cq.message.edit_text(
            ...
            await cq.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "🔙 الرجوع", callback_data=f"category_{category}"
                            )
                        ],
                        [
                            InlineKeyboardButton(
        ...
        # ---- القرآن ----
            ...
            await cq.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "📚 قائمة السور", callback_data="surah_list"
                            )
                        ],
                        [
                            InlineKeyboardButton(
                                "🔙 العودة", callback_data="back_to_start"
                            )
                        ],
                    ]
                ),
            ...
            for i in range(1, 115, 2):
                ...
                if s2:
                    row.append(
                        InlineKeyboardButton(
                            f"{i+1}-{s2}", callback_data=f"surah_{i+1}"
                        )
                    )
                keyboard_list.append(row)
            keyboard_list.append(
                [InlineKeyboardButton("🔙 الرجوع", callback_data="quran_menu")]
            )
            await cq.message.edit_text(
                "📚 **اختر السورة:**",
                reply_markup=InlineKeyboardMarkup(keyboard_list),
