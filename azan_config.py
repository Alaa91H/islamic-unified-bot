...
AZAN_SOURCES = {
    'traditional': {
        'name': 'الأذان التقليدي',
        'fajr': 'https://example.com/azan/traditional_fajr.mp3',
        'dhuhr': 'https://example.com/azan/traditional_dhuhr.mp3',
        'asr': 'https://example.com/azan/traditional_asr.mp3',
        'maghrib': 'https://example.com/azan/traditional_maghrib.mp3',
        'isha': 'https://example.com/azan/traditional_isha.mp3',
    },
    'abdul_basit': {
        'name': 'الأذان - عبد الباسط عبد الصمد',
        'fajr': 'https://example.com/azan/abdulbasit_fajr.mp3',
        'dhuhr': 'https://example.com/azan/abdulbasit_dhuhr.mp3',
        'asr': 'https://example.com/azan/abdulbasit_asr.mp3',
        'maghrib': 'https://example.com/azan/abdulbasit_maghrib.mp3',
        'isha': 'https://example.com/azan/abdulbasit_isha.mp3',
    },
    'ahmed_al_ajmi': {
...
QURANIC_RECITERS = {
    'abdul_basit': {
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/afs/',
    ...
    'mishari_al_affasy': {
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/alafasy/',
        'available_surahs': list(range(1, 115))
    },
    'ahmed_al_ajmi': {
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/alajmi/',
        'available_surahs': list(range(1, 115))
    },
    'saad_al_ghamdi': {
        'name': 'سعد الغامدي',
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/saadighamdi/',
        'available_surahs': list(range(1, 115))
    },
    'maher_al_meaqli': {
        'name': 'ماهر المعيقلي',
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/maheralmaqli/',
        'available_surahs': list(range(1, 115))
    },
    'yasser_al_dosari': {
        'name': 'ياسر الدوسري',
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/yasseralQosi/',
        'available_surahs': list(range(1, 115))
    },
    'abdul_rahman_al_sudais': {
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/abdulrahman/',
        'available_surahs': list(range(1, 115))
    },
    'nasser_al_qatami': {
        'name': 'ناصر القطامي',
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/nasser/',
        'available_surahs': list(range(1, 115))
    },
    'muhammad_al_tablawi': {
        'name': 'محمد الطبلاوي',
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/altablawi/',
        'available_surahs': list(range(1, 115))
    },
    'abdul_muhsin_al_qasim': {
        ...
        'stream_url': 'https://quran.kalamullah.com/mp3/abdulmaohsinqasem/',
        'available_surahs': list(range(1, 115))
    }
}
